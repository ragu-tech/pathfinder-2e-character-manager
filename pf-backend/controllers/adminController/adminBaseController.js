...
var createAdmin = function (userData, payloadData, callback) {
  ...
  async.series(
    [
      ...
      function (cb) {
        payloadData.tempPassword = UniversalFunctions.generateRandomString();
        payloadData.password = UniversalFunctions.CryptData(payloadData.tempPassword);
